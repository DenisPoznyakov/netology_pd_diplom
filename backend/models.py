...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, email, password, **extra_fields):
        """
        Создание и сохранение пользователя, с указанием
        имени пользователя, адреса электронной почты и пароля.
        """
        if not email:
...
class Shop(models.Model):
    ...
    def __str__(self):
        """Возвращает название магазина для отображения в админке и API"""
        return self.name
...
class ProductInfo(models.Model):
    ...
    external_id = models.PositiveIntegerField(verbose_name='Внешний ID товара в прайсе')
...
class Parameter(models.Model):
    ...
    def __str__(self):
        """Возвращает название параметра (например, 'Цвет', 'Объём')"""
        return self.name
...
class Order(models.Model):
    ...
    def total_sum(self):
        """
        Возвращает общую сумму заказа (количество × цена за позицию)
        """
        return sum(
...
class ConfirmEmailToken(models.Model):
    ...
    def __str__(self):
        """Токен подтверждения email для пользователя {user}"""
